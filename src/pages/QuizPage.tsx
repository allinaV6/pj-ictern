    ...
    <div className="min-h-screen bg-gray-50 font-sans pb-24">
      ...
      <div className="bg-blue-900 text-white py-10 px-4">
        <div className="max-w-6xl mx-auto text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-bold mb-3">แบบทดสอบรวมของตำแหน่งที่คุณเลือก</h1>
      ...
      <div className="max-w-3xl mx-auto px-4 mt-8">
          ...
          <div className="space-y-3 flex-grow">
            {CHOICES.map((choice) => (
              <button
                ...
                className={`w-full text-left p-4 rounded-lg border text-base transition-colors ${
        ...
        <div className="flex items-center justify-between mt-8">
            <button 
              ...
              className={`flex items-center gap-2 px-6 py-2.5 rounded-lg border bg-white text-base ${currentQuestionIndex === 0 ? 'text-gray-300 cursor-not-allowed' : 'text-gray-600 hover:bg-gray-50'}`}
            >
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-6 py-2.5 rounded-lg font-bold text-white text-base ${!selectedAnswer ? 'bg-gray-300 cursor-not-allowed' : 'bg-blue-900 hover:bg-blue-800'}`}
            >
