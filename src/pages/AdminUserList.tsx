...
export default function AdminUserList() {
  ...
  const users = [
    {
      id: 1,
      name: 'Chonthicha Preecharak',
      email: 'chonthicha.pre@student.mahidol.ac.th',
      program: 'DST',
      workplace: 'Krungsri',
      status: 'Active',
    },
    {
      id: 2,
      name: 'Nanucha Sakda',
      email: 'Nanucha.Sak@student.mahidol.ac.th',
      program: 'ICT',
      workplace: 'SCB',
      status: 'Active',
    },
    ...
    <AdminLayout>
      <div className="bg-blue-900 text-white px-4 py-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="px-5 py-2.5 rounded-lg border border-gray-200 bg-white text-gray-700 font-semibold text-base hover:bg-gray-100">
              นำออก/นำเข้าข้อมูล
            </button>
            <button
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="grid grid-cols-[2fr_2fr_1fr_1.5fr_1fr] px-6 py-3 text-sm font-semibold text-gray-500 bg-gray-50 border-b border-gray-200">
            <div>ชื่อ-นามสกุล</div>
            <div>E-mail</div>
            <div>Program</div>
            <div>สถานที่ฝึกงาน</div>
            <div className="text-right pr-6">สถานะ</div>
          </div>

          {users.map((user) => (
            <div
              key={user.id}
              className="grid grid-cols-[2fr_2fr_1fr_1.5fr_1fr] px-6 py-4 text-base text-gray-800 items-center border-b border-gray-100 last:border-b-0 cursor-pointer hover:bg-blue-50 transition-colors duration-150"
